...
const Careers = (props) => {
  ...
  return (
    <div className="careers submenu">
      <div
        className="careers_title title"
        style={{ backgroundImage: `url(${bg})` }}
      >
        <div className="careers_title-overlay title-background-overlay">
          <section>{thisMenu.title}</section>
        </div>
      </div>
      <div className="careers_info info">
        <div className="careers_info-navigation info-navigation">
          <ul>
        ...
        <div className="careers_info-details info-details">
          {thisMenu.details}
          {thisMenu.image && (
