...
const Bs = (props) => {
  ...
  return (
    <div className="backend-services bs submenu">
      <div className="bs_title title" style={{ backgroundImage: `url(${bg})` }}>
        <div className="bs_title-overlay title-background-overlay">
          <section>{thisMenu.title}</section>
        </div>
      </div>
      <div className="bs_info info">
        <div className="bs_info-navigation info-navigation">
          <ul>
        ...
        <div className="bs_info-details info-details">
          {thisMenu.details}
          {thisMenu.image && (
